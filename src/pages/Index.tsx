...
import { ActivitySquare, Brain, ChevronRight, Clock } from 'lucide-react'
    ...
    <div className="min-h-screen flex flex-col bg-gradient-to-b from-blue-50 to-white">
      <div className="flex-1 flex flex-col items-center justify-center p-6 space-y-8 max-w-lg mx-auto">
        ...
        >
          ...
          >
            Your daily 50-minute structured session to improve focus and
            executive function
          </motion.p>
        </motion.div>
          ...
          <div className="grid grid-cols-2 gap-4 pt-2 max-w-md mx-auto w-full">
            ...
            >
              <Button
                ...
                variant="outline"
                className="w-full py-5 rounded-xl border-2 hover:bg-secondary/50 transition-all duration-300 flex items-center justify-center text-foreground"
              >
