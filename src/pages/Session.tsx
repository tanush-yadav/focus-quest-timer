...
const Session = () => {
  ...
  const handleExerciseComplete = () => {
    ...
    setCurrentExercise((prev) => {
      ...
      if (next >= 3) {
        // Assuming there are 3 exercises
        switchToQuiz()
      }
      return next
    })
  ...
  const switchToQuiz = () => {
    ...
    toast({
      ...
      description:
        "Well done on the focus exercises! Now let's test your knowledge",
    })
  }
        ...
        return (
          ...
          >
            ...
            <p className="mb-8 text-gray-600 max-w-md mx-auto">
              Your 50-minute session includes focus exercises and knowledge
              quizzes designed to improve ADHD management skills.
            </p>
            <motion.div
        ...
        return (
          ...
          >
            ...
            <p className="mb-6 text-gray-600">
              Great job on completing today's training session. Take a 10-minute
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
              ...
              <div>
                ...
                >
                  <div
                    ...
                    style={{ width: `${(timeLeft / (50 * 60)) * 100}%` }}
                  />
                </Progress>
              </div>
            </div>
      ...
      <div className="flex-1 flex items-center justify-center p-6">
        <AnimatePresence mode="wait">{renderSessionContent()}</AnimatePresence>
      </div>
    </div>
  )
}
